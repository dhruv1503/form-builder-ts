...
function initialValues(formElement : HTMLFormElement, name: string, value : any) : void{
const inputElement = formElement.querySelector(`input[name=${name}]`)  as HTMLInputElement
